...
import 'package:me_reserve_bem_estar/feature/provider/widgets/provider_filter_view.dart';
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: ResponsiveHelper.isDesktop(context)? Get.height*0.7:Get.height*0.9,child: const WebShadowWrap(child: Center(child: CircularProgressIndicator()))):
