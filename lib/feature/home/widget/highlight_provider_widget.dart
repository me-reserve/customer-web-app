          ...
          Padding(padding: const EdgeInsets.symmetric(vertical : Dimensions.paddingSizeDefault),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                child: Text('highlight_for_you'.tr, style: ubuntuBold.copyWith(
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                child: Text('see_our_most_popular_providers_and_service'.tr, style: ubuntuRegular.copyWith(
             ...
             const SizedBox(height: Dimensions.paddingSizeDefault ,),
              ...
              CarouselSlider.builder(
                options: CarouselOptions(
                  ...
                  aspectRatio: ResponsiveHelper.isTab(context) ? 13/9 : 11/9,
                  viewportFraction: 1,
                  disableCenter: true,
...
class _AdvertisementVideoPromotionWidgetState extends State<AdvertisementVideoPromotionWidget> {
  ...
  Future<void> initializePlayer() async {
    videoPlayerController = VideoPlayerController.networkUrl(Uri.parse(
        "${Get.find<SplashController>().configModel.content?.imageBaseUrl}${AppConstants.advertisementPath}${widget.advertisement.promotionalVideo}"
    ));
                ...
                AspectRatio(
                  ...
                  child: ClipRRect(
                    ...
                    child: CustomImage(
                      ...
                      image:  "${Get.find<SplashController>().configModel.content?.imageBaseUrl}${AppConstants.advertisementPath}${advertisement.providerCoverImage!}",
                    ),
                  ),
                ),
                Container(
                  ...
                  child: Row( children: [
                    ...
                    ClipRRect(
                      ...
                      child: CustomImage(
                        image:  "${Get.find<SplashController>().configModel.content?.imageBaseUrl}${AppConstants.advertisementPath}${advertisement.providerProfileImage!}",
                        height: 60, width: 60,
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column( crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Row(children: [
                          ...
                          Text('${advertisement.providerData?.ratingCount} ${'reviews'.tr}', style: ubuntuRegular.copyWith(
                              color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall
                          ),),
                        ],)
                      ]),
