import 'package:me_reserve_bem_estar/components/service_widget_vertical.dart';
import 'package:me_reserve_bem_estar/components/core_export.dart';
import 'package:get/get.dart';

class WebTrendingServiceView extends StatelessWidget {
  const WebTrendingServiceView({super.key}) ;
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ServiceWidgetVertical(service: serviceController.trendingServiceList![index],fromType: '',);
                    },
                  )
                ],
              );
