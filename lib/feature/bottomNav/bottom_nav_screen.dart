      ...
      child: Scaffold(
        ...
        floatingActionButton: ResponsiveHelper.isDesktop(context) ? null : InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: _pageIndex == 2 ? null : Get.isDarkMode ? Theme.of(context).colorScheme.primary : Theme.of(context).primaryColor,
        ...
        SafeArea(
          child: Container(
            ...
            color:Get.isDarkMode ? Theme.of(context).cardColor.withOpacity(.5) : Theme.of(context).cardColor,
            child: Row(children: [
              _bnbItem(
