...
class RateReviewScreen extends StatefulWidget{
  final String id;
  const RateReviewScreen({super.key, required this.id}) ;
...
class EditableReview extends StatelessWidget {
 ...
 final String variations;
  const EditableReview({super.key,required this.submitReviewController, required this.index, required this.variations}) ;
...
class NonEditableReview extends StatelessWidget {
  ...
  final int index;
  final String variations;
  const NonEditableReview({super.key,required this.submitReviewController, required this.index, required this.variations}) ;
