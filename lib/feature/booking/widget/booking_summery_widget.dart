...
class BookingSummeryWidget extends StatelessWidget{
  ...
  const BookingSummeryWidget({super.key, required this.bookingDetailsContent}) ;
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Directionality(
                              textDirection: TextDirection.ltr,
                              child: Text('(-) ${PriceConverter.convertPrice(bookingDetailsController.bookingDetailsContent!.totalCouponDiscountAmount ?? 0)}',
                                style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color!),),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Directionality(
                              textDirection: TextDirection.ltr,
                              child: Text('(-) ${PriceConverter.convertPrice(bookingDetailsController.bookingDetailsContent!.totalCampaignDiscountAmount ?? 0)}',
                                style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color!)),
                            ),
                          ],
                        ),
...
class ServiceInfoItem extends StatelessWidget {
  ...
  const ServiceInfoItem({super.key,required this.bookingService,required this.bookingDetailsController, required this.index, required this.bookingDetailsContent}) ;
  @override
  Widget build(BuildContext context) {
